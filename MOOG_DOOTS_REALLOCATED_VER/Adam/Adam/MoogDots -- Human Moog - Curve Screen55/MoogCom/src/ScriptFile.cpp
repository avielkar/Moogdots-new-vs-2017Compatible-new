...
bool CScriptFile::Load(const string& commandString, ofstream& logFile)
{
#define MAX_LINE_LENGTH 1000
	...
	else
	{
		...
		while ((ReadLineInCommandStrings(szBuffer, commandString, placeIncommandsString , logFile) > 0) &&
