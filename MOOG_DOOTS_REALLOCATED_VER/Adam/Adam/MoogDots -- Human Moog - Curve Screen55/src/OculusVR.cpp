...
const OVR::Matrix4f OculusVR::OnEyeRender(int eyeIndex, ovrVector3f eyePos, ovrVector3f centerPos, ovrVector3f upPos , float nearZ , float farZ)
{
...
void OculusVR::OnCtrlKeyPress(KeyCode key)
{
	switch (key)
	{
	case KEY_SPACE:
