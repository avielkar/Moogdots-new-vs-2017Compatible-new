...
if motiontype == 1    
    ...
    surgeGL2 = dGL2*xGL2*0 + surgeGL1(end);
%     WallDistance-DepthOffset
%     surgeGL2 = dGL2*xGL2*0 + surgeGL1(end) + (WallDistance-DepthOffset); % Null second interval movement and set comp distance    
%     surgeGL2 = dGL2*xGL2*0 + surgeGL1(end) - (WallDistance*DepthOffset); % Null second interval movement and set comp distance
