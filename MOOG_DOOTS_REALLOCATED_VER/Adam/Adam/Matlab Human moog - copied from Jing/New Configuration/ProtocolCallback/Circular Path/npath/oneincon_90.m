...
qangular=[0 curamp dur(1,1)/2 1/cursig];
    ...
    %NOTE: This is where Pogen edited code for 90 deg condition
    %Do this for translation by swapping lateral(x) and surge(y)
    temp1 = xMeven; xMeven = yMeven; yMeven = temp1;
    temp2 = xModd; xModd = yModd; yModd = temp2;
