...
if motiontype == 3 % 2I vars required as well
    ...
    %%%%% 2nd heading is used to set a different ref elevation plane with
    %%%%% respect to the first one. To prevent confusion, this is saved in
    %%%%% a new variable called dev.
        dev(1) = amps(1,2)
