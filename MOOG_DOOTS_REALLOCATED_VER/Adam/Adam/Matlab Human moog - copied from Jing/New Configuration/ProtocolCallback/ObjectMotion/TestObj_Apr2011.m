...
%%%%%%%%%%     First distance = 6 cm %%% if (activeStair == 5) %%%% Rightward self-motion --> 90/90
    if (activeStair == 1)
    dist(1,1) = 0.00001;
    dist(2,1) = 6;
...
%%%%%%%%%%   Second distance = 11 cm %%%if (activeStair == 6) %%%% Rightward self-motion --> 90/90
if (activeStair == 2)
    dist(1,1) = 0.00001;
    dist(2,1) = 11;
    i = strmatch('BACKGROUND_ON',{char(data.configinfo.name)},'exact');
...
%%%%%%%%%%%%%% Third distance = 16 cm %%%%if (activeStair == 7) %%%% Rightward self-motion --> 90/90
if (activeStair == 3)
    dist(1,1) = 0.00001;
    dist(2,1) = 16;
    i = strmatch('BACKGROUND_ON',{char(data.configinfo.name)},'exact');
...
%%%%%%%%%     First distance = 6 cm %%%if (activeStair == 8) %%%% Rightward self-motion --> 90/90
if (activeStair == 4)
    dist(1,1) = 6;
    dist(2,1) = 6;
    i = strmatch('BACKGROUND_ON',{char(data.configinfo.name)},'exact');
...
%%%%%%%%%%%     Second distance = 11 cm %%%if (activeStair == 9) %%%% Rightward self-motion --> 90/90
if (activeStair == 5)
    dist(1,1) = 11;
    dist(2,1) = 11;
    i = strmatch('BACKGROUND_ON',{char(data.configinfo.name)},'exact');
...
%%%%%%%%%%%     Third distance = 16 cm %%%%if (activeStair == 10) %%%% Rightward self-motion --> 90/90
if (activeStair == 6)
    dist(1,1) = 16;
    dist(2,1) = 16;
    i = strmatch('BACKGROUND_ON',{char(data.configinfo.name)},'exact');
