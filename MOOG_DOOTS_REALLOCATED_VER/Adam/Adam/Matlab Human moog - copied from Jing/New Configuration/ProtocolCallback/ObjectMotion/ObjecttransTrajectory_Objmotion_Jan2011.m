...
% % % if (activeStair == 3)
% % %     dist(1,1) = 11;
% % %     dist(2,1) = 11;  %%% this cannot be zero.
% % %     i = strmatch('BACKGROUND_ON',{char(data.configinfo.name)},'exact');
% % %     data.configinfo(i).parameters = 0;
% % %     setappdata(appHandle, 'protinfo',data);
% % % end
...
% % if (activeStair == 1)
% %     dist(1,1) = 16;
% %     dist(2,1) = 16;  %%% this cannot be zero.
% %     i = strmatch('BACKGROUND_ON',{char(data.configinfo.name)},'exact');
% %     data.configinfo(i).parameters = 0;
% %     setappdata(appHandle, 'protinfo',data);
% % end
...
% % % % %%%%%%%%%%%%%%%% Staircase = 5/6/7 for VISUAL + OBJ.
% % %%%%%%%%%%%%     First distance = 6 cm.
% % if (activeStair == 5)
% %     dist(1,1) = 0.00001;
% %     dist(2,1) = 6;
...
% % %%%%%%%%%%%%%% Staircase = 8/9/10 for VEST + VISUAL + OBJ.
% % %%%%%%%%%%     First distance = 6 cm.
% % if (activeStair == 8)
% %     dist(1,1) = 6;
% %     dist(2,1) = 6;
