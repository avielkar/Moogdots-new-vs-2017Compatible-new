...
% %%%% SETTING APPROPRIATE STAR SIZE.
% i = strmatch('STAR_SIZE',{char(data.configinfo.name)},'exact');
% data.configinfo(i).parameters = [1 1];
...
% %%%%%% SET 2 : WITH LEFT-TO-RIGHT OBJECT MOTION.
...
%     data.configinfo(i).parameters = [-27.7 0 0];
%     setappdata(appHandle,'protinfo',data);
% end
...
% % %%%%%% SET 3 : WITH RIGHT-TO-LEFT OBJECT MOTION.
...
% %     setappdata(appHandle,'protinfo',data);
% %     i = strmatch('OBJECT_ELE',{char(data.configinfo.name)},'exact');
% %     data.configinfo(i).parameters = 180;
% %     setappdata(appHandle,'protinfo',data);
% %         
% %     i = strmatch('OBJECT_POS',{char(data.configinfo.name)},'exact');
% %     data.configinfo(i).parameters = [27.7 0 0];
