function [data] = GenTrapezoidVel(time, vel, time1, time2, frequency)
...
accel = diff(vel)/time_step;

% figure
% subplot(3,1,1), plot(t,data); hold on;
% subplot(3,1,2), plot(t(1: end-1),vel); hold on;
% subplot(3,1,3), plot(t(1: end-2),accel); hold on;
% 
%  
