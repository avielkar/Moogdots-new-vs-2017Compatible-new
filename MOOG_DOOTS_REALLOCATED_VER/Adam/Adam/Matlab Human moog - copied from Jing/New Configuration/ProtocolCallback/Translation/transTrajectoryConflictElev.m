...
% set origin depending on heading direction
if refplaneaz==1
    latpos=sin(azP(1,1)/180*pi)*dist(1,1);
    forpos=cos(azP(1,1)/180*pi)*dist(1,1);
    amps(1,1)
    origin=[-latpos -forpos 0]
else
    verpos=sin(elP(1,1)/180*pi)*dist(1,1);
    forpos=cos(elP(1,1)/180*pi)*dist(1,1);
    amps(1,1)
