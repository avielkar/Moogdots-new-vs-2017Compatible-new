...
COMBOARDNUM = 0;
outString = 'ENABLE_CYLINDERS 1.0'; %hack to enable cylinders to come up at the end of the movement
if connected
    cbDWriteString(COMBOARDNUM, sprintf('%s\n', outString), 5);
end

outString = 'ENABLE_FLOOR 1'; %hack to enable floor to come up at the end of the movement
if connected 
    cbDWriteString(COMBOARDNUM, sprintf('%s\n', outString), 5);
end
