...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    FIRSTPORTC=FIRSTPORTA;
	SECONDPORTC=SECONDPORTA;
    ...
    errorCode = cbDIn(boardNum, SECONDPORTB, &recVal);
    if (recVal) {
        #if VERBOSE_MODE
        ...
        do {
            ...
            do {
                if (cbDIn(boardNum, SECONDPORTB, &recVal) != 0) {
            ...
            if (cbDOut(boardNum, FIRSTPORTC, (unsigned short)0) != 0) {   
